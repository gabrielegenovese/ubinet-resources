...
tc qdisc add dev eth0 root netem rate 1mbit delay 10ms
echo "sleeping 10s ..."
sleep 10
...
tc qdisc del dev eth0 root
tc qdisc add dev eth0 root netem rate 350kbit delay 10ms
sleep 75
echo "fixing bw to 2 Mps for 125s"
tc qdisc del dev eth0 root
tc qdisc add dev eth0 root netem rate 2mbit delay 10ms
sleep 125
